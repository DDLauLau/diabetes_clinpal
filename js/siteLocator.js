/**
 * Created by AndySmith on 27/08/2014.
 */
var mapDiv;
var map;
var bounds;
...
function getSiteData(lat, lng, locName) {
    ...
    var contextPathTag = document.getElementsByName("contextPath");
    var controllerMapping = contextPathTag[0].getAttribute("content") + '/sitesForTrial/NCT02104674';
    var contextPath = contextPathTag[0].getAttribute("content")
    ...
    $.ajax({
        ...
        success: function (data) {
            $.each(data, function (index) {
                ...
                console.log("SITE NAME" + data[index].name);
                if (lat != undefined) {
